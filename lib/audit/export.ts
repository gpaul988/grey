...
export function exportAsHTML(report: AuditReport): string {
    ...
    return `
        ...
        <head>
            ...
            <title>Audit Report - Graham Sobiribo Paul</title>
            <style>
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <p>Generated by Graham Sobiribo Paul Audit Engine</p>
                    <div class="targets">
                ...
                <div class="cta-box">
                    ...
                    <p style="margin-top: 16px; font-size: 13px; color: #6b7280;">
                        <strong>Graham Sobiribo Paul</strong> • Port Harcourt, Nigeria<br>
