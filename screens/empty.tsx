...
export default function AppStoreOptimization(): React.ReactElement {
    ...
    const numericStats = stats.map(s => ({
        label: s.label,
        value: (typeof s.percent === 'number' ? s.percent : Number(s.value))
    }));
    return (
        ...
        >
            ...
            <motion.div initial={{opacity: 0, y: 8}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}
                ...
                <ServiceIntro
                    ...
                    body={<>We combine keyword intelligence, conversion-focused creative, and continuous experimentation
                        to make your app discoverable and highly converting in app stores.</>}
                />
                ...
                <div className="max-w-6xl mx-auto grid gap-12 md:gap-20 mt-12 px-6">
                    <motion.div whileInView={{opacity: 1, y: 0}} initial={{opacity: 0, y: 16}} viewport={{once: true}}>
                        <ServiceSectionBlock
                            ...
                            body={<>Competitive analysis, keyword opportunity modeling, and a prioritized roadmap
                                focused on high-impact, high-intent terms and localized markets.</>}
                    ...
                    <motion.div whileInView={{opacity: 1, y: 0}} initial={{opacity: 0, y: 20}} viewport={{once: true}}>
                        <ServiceSectionBlock
                            ...
                            body={<>Design-first app icons, screenshots, and preview videos optimized for conversion
                                with continuous A/B testing and store-specific best practices.</>}
                    ...
                    <motion.div whileInView={{opacity: 1, y: 0}} initial={{opacity: 0, y: 20}} viewport={{once: true}}>
                        <ServiceSectionBlock
                            ...
                            body={<>Metadata engineering, long-tail keyword capture, and structured experiments to
                                maximize indexation and search ranking across stores and regions.</>}
                ...
                <div className="max-w-6xl mx-auto px-6 mt-16">
                    <FuturisticDevelopmentProcess day={isDayTime}
                                                  description="Iterative ASO loop: Discover → Test → Iterate → Scale. We pair data science with creative experimentation to unlock organic growth."/>
                </div>
