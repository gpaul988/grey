...
const Consulting = () => (
    <ServicePageTemplate
        ...
        introBody={[
            <>Technology decisions made today lock in the trajectory of your business for years. At Grey InfoTech we provide the strategic counsel and hands-on expertise to help you make those decisions
