...
const NextjsDevelopment = () => {    const [isVisible, setIsVisible] = useState(false);
    ...
    return (
        <div className={`${isDayTime ? 'bg-white' : 'bg-black'} min-h-screen`}>
            ...
            <ServiceHero
                ...
                subtitle="Server-rendered apps and optimised experiences"
                accentColor="#00f5d4"
                variant="particles"
                badges={["SSG","SSR","Edge","Performance"]}
                ctaHref="/contact"
