...
const HybridAppDevelopment = () => {    const sectionRef = useRef<HTMLDivElement>(null);
    ...
    return (
        <div className={`${isDayTime ? 'bg-white' : 'bg-black'} min-h-screen`}>
            ...
            <div id={'hero'}
                ...
                <h1
                    className={`border-b pb-[0.5em] border-gray-500/50 px-0 gx-hero-title constant-text lg:text-[5em] md:text-[3em] sm:text-[2em] text-[2.5em] lg:mt-[3em] mt-[1.5em] leading-[1.1] font-[800] ${
