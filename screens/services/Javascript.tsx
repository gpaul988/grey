    ...
    <ServicePageTemplate
        ...
        solutions={[
            ...
            },
            {
                ...
                body: <>Ensure your JavaScript application becomes a high-performing, value-driven asset by partnering with Grey 
                    InfoTech. We provide end-to-end support from strategic planning and development to testing, risk mitigation, 
