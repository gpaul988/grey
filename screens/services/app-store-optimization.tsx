...
import { FxBackground, FxChip, FxReveal, FxButton, FxHoloCard } from '@/components/futuristic/fx';type TechItem = {
    id: string;
    title: string;
...
const AppStoreOptimization = () => {    const [isVisible, setIsVisible] = useState(false);
