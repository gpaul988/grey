            ...
            <section ref={processSectionRef} id={'process'} className={`relative ${isDayTime ? 'bg-white text-black' : 'bg-black text-white'}`}>
                ...
                <div className={`relative border-b px-6 sm:px-10 lg:px-[4.6em] pt-24 pb-10 overflow-hidden ${isDayTime ? 'border-gray-200' : 'border-gray-900'}`}>
                    ...
                    <div className="absolute inset-0 opacity-[0.03]" style={{
                        backgroundImage: `linear-gradient(${isDayTime ? '#000' : '#fff'} 1px, transparent 1px), linear-gradient(90deg, ${isDayTime ? '#000' : '#fff'} 1px, transparent 1px)`,
                ...
                <div className="relative lg:grid lg:grid-cols-2">
                    ...
                    <div className={`px-6 sm:px-10 lg:px-[4.6em] lg:pr-12 py-0 lg:pb-32 ${isDayTime ? '' : ''}`}>
                        {[
                            {
                                id: 'ideation',
                            ...
                            <div
                                key={stage.id}
                                id={stage.id}
                                className={`relative py-16 lg:py-28 border-b last:border-b-0 group ${isDayTime ? 'border-gray-100' : 'border-gray-900'}`}
                            >
