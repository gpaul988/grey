...
import { FxBackground, FxChip, FxReveal, FxButton, FxHoloCard } from '@/components/futuristic/fx';interface ProcessStep {
    title: string;
    content: string[];
}

const ErpDevelopment = () => {    const [isVisible, setIsVisible] = useState(false);
