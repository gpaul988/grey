...
- Name: admin.spec.ts >> Admin Dashboard E2E >> Export PDF button exists
- Location: e2e\admin.spec.ts:104:7
...
Locator: locator('[id="main-content"] button:has-text("Export PDF"), main button:has-text("Export PDF")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[id="main-content"] button:has-text("Export PDF"), main button:has-text("Export PDF")').first()
