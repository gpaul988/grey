...
- Name: admin.spec.ts >> Accessibility Tests >> Colors have sufficient contrast
- Location: e2e\admin.spec.ts:251:7
...
```yaml
- generic [active] [ref=e1]: "{\"error\":\"Too many attempts. Please wait a few minutes and try again.\"}"
```
