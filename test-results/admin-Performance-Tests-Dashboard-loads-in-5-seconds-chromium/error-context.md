...
- Name: admin.spec.ts >> Performance Tests >> Dashboard loads in <5 seconds
- Location: e2e\admin.spec.ts:203:7
...
Locator: locator('h2:has-text("Analytics & Insights")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2:has-text("Analytics & Insights")')
