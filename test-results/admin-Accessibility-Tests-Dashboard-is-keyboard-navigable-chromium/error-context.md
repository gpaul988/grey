...
- Name: admin.spec.ts >> Accessibility Tests >> Dashboard is keyboard navigable
- Location: e2e\admin.spec.ts:237:7
...
Expected value: "DIV"
Received array: ["BUTTON", "A", "INPUT"]
```

# Page snapshot

```yaml
- generic [ref=e1]: "{\"error\":\"Too many attempts. Please wait a few minutes and try again.\"}"
```
