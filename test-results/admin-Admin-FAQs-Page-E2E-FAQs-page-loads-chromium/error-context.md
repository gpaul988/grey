...
- Name: admin.spec.ts >> Admin FAQs Page E2E >> FAQs page loads
- Location: e2e\admin.spec.ts:150:7
...
Locator: locator('h1:has-text("Admin FAQs")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Admin FAQs")')
