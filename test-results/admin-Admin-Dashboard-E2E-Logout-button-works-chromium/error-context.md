...
- Name: admin.spec.ts >> Admin Dashboard E2E >> Logout button works
- Location: e2e\admin.spec.ts:133:7
...
Locator: locator('[id="main-content"] button:has-text("Logout"), main button:has-text("Logout")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[id="main-content"] button:has-text("Logout"), main button:has-text("Logout")').first()
