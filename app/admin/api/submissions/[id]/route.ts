...
export async function PATCH(
  ...
  try {
    ...
    console.log('[admin-submissions-patch] Received update for ID:', id);
    console.log('[admin-submissions-patch] Body:', body);
    ...
    console.log('[admin-submissions-patch] Executing update:', updateSql);
    console.log('[admin-submissions-patch] Values:', values);

    const stmt = db.prepare(updateSql);
    const result = stmt.run(...values);

    console.log('[admin-submissions-patch] Update result:', result);
...
export async function DELETE(
  ...
  try {
    ...
    console.log('[admin-submissions-delete] Submission deleted:', id);
