...
const PROCESSES = [
  {
    id: 'ideation',
    label: 'Moodboards',
    title: 'Moodboards & Ideation',
    tags: ['Workshops', 'Competitor Analysis', 'Flow Diagrams'],
    image: '/assets/ui-ux/stages/ideation.jpg',
    color: '#00f5d4',
    accent: 'from-cyan-400/20 to-teal-600/10',
    description:
      'We create moodboards to establish the visual direction of your product, laying the groundwork for typography, iconography, and graphic design. This early-stage exploration allows us to experiment with a wide range of styles and themes.',
  },
  {
    id: 'research',
    label: 'Research',
    ...
    image: '/assets/ui-ux/stages/research.jpg',
    color: '#7c3aed',
    accent: 'from-violet-400/20 to-purple-600/10',
    description:
      'Our process begins with in-depth research to understand your audience\'s needs and behaviors. Through strategic analysis, we uncover valuable insights that inform every stage and ensure we create intuitive, engaging digital experiences.',
  },
  {
    id: 'guidelines',
    label: 'Guidelines',
    ...
    image: '/assets/ui-ux/stages/guidelines.jpg',
    color: '#22d3ee',
    accent: 'from-sky-400/20 to-blue-600/10',
    description:
      'Consistency at scale is key to building cohesive products. We develop comprehensive design systems—a toolkit of reusable components and clear guidelines that streamline collaboration and ensure visual consistency across all touchpoints.',
  },
  {
    id: 'vd',
    label: 'Visual Design',
    ...
    image: '/assets/ui-ux/stages/vd.jpg',
    color: '#ec4899',
    accent: 'from-pink-400/20 to-rose-600/10',
    description:
      'Our design phase focuses on structure and functionality using wireframes and interactive prototypes. We prioritize intuitive navigation and clear hierarchy before layering in brand identity and visual elements.',
  },
  {
    id: 'testing',
    label: 'Testing',
    ...
    description:
      'Usability testing puts your product in users\' hands to uncover design flaws and opportunities. By observing real interactions, we gain invaluable insights that enhance satisfaction and boost performance.',
  },
  {
    id: 'rounds',
    label: 'Feedback',
    title: 'Feedback Rounds & Iteration',
    tags: ['Collaborative Reviews', 'Iterations', 'Refinement'],
    image: '/assets/ui-ux/stages/rounds.jpg',
    color: '#10b981',
    accent: 'from-green-400/20 to-emerald-600/10',
    description:
      'We work collaboratively through regular check-ins and reviews at every stage. Using real-world data and analytics, we continuously refine the design—optimizing performance and ensuring maximum impact.',
  },
];
...
/*  -  -  -  Main component  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  */
export default function ProcessesSection({ isDayTime = false }: { isDayTime?: boolean }) {
  ...
  const updateActiveService = useCallback(() => {
    const serviceEls = PROCESSES.map((s) => document.getElementById(`proc-${s.id}`));
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="mt-3 text-[0.9em] max-w-lg" style={{ color: muted }}>
            From discovery to launch—a proven methodology ensuring exceptional user experiences at every step.
          </p>
        </motion.div>
      ...
      <div className="relative lg:grid lg:grid-cols-2">
        ...
        <div className="px-6 sm:px-10 lg:px-[4.6em] lg:pr-12 py-0 lg:pb-32">
          {PROCESSES.map((proc, i) => (
            ...
            >
              ...
              {/* CTA */}
              <Link href={`/services/ui-ux-design#${proc.id}`}>
                <motion.button
        ...
        <div className="hidden lg:block" style={{ height: `${PROCESSES.length * 520}px` }}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-[0.72em] font-mono text-white/50">
                        {activeIndex + 1}/{PROCESSES.length}
                      </span>
                    </div>
                    ...
                    <div className="flex gap-2 mt-4">
                      {PROCESSES.map((s, i) => (
                        <motion.button
                          ...
                          style={{
                            background: activeIndex === i ? s.color : 'rgba(255,255,255,0.3)',
                          }}
