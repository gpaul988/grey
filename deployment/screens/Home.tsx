...
const Home = () => {
    ...
    // Always call the hook at the same position — pass target only after hydration
    const {scrollYProgress: scrollYProgressValue} = useScroll({target: isHydrated ? whyUsRef : undefined});
