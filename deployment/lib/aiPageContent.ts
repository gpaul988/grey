...
export const PAGE_KB: KbDoc[] = [
    ...
    {
        "title": "Quote Request & AI Estimator",
        "url": "/quote-request",
        "body": "Get a tailored estimate fast: request a quote or use our AI Project Estimator at /quote-request. Pricing depends on scope, complexity and timeline — we respond with a fixed-price estimate, often within 24 hours.",
        "tags": [
            "quote",
            "estimate",
            "pricing",
    ...
    },
    {
        ...
        "url": "/support",
        "body": "Existing clients can open a support ticket at /support or /open-ticket and our team will respond.",
        "tags": [
            "support",
            "help",
            "ticket",
    ...
    },
    {
        "title": "Company",
        "url": "/company",
        "body": "Grey InfoTech Limited is a web, mobile, AI and digital marketing agency founded in 2017 in Port Harcourt, Nigeria. We build scalable, user-centered products for startups and enterprises.",
        "tags": [
            "company",
            "about",
            "who",
