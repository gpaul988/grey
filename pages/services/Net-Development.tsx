...
const testimonials = [
    {
        ...
        message: (
            <>
                They delivered a robust .NET-based financial platform that powered our digital lending and credit
                scoring services at FinNova. Their team was reliable, technically sound, and responsive throughout the
    ...
    },
    {
        ...
        message: (
            <>
                At AgroLink, we needed a powerful backend system to connect farmers with suppliers and financial
                institutions. Grey InfoTech built exactly that using .NET technologies. Their deep technical
                understanding and ability to adapt quickly to our evolving needs helped us deliver real value in the
                field.
            </>
        )
    },
    {
        ...
        message: (
            <>
                Grey InfoTech helped us develop a secure and scalable health data management system with .NET. It
                enabled clinics and mobile health units across Mali to manage patient records, appointments, and
