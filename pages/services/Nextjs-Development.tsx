...
const testimonials = [
    {
        name: "Lebo Makgatho",
        title: "Chief Digital Officer, PropEdge Technologies",
        message: (
            <>
                They brought a new level of performance and scalability to our real estate platform using Next.js. The
                pages now load faster, SEO has improved, and our user engagement is noticeably higher. Their team was
                efficient, skilled, and a pleasure to work with.
            </>
        ),
    },
    {
        ...
        message: (
            <>
                We partnered with Grey InfoTech to rebuild our frontend using Next.js, and the results were exceptional.
                The application is now faster, more dynamic, and easier to manage. Their team’s attention to detail and
                deep understanding of modern web architecture made all the difference.
            </>
        )
    },
    {
        name: "Nia Toure",
        title: "Director of Engineering, PayCore Solutions",
        message: (
            <>
                They helped us transition to a modern, server-rendered architecture with Next.js that
                drastically improved our site speed and security. Their developers were knowledgeable and responsive,
                delivering exactly what we needed — on time and with zero stress.
            </>
        )
    },
    {
        name: "Oluwaseun Kalu",
        title: "Product Lead, LogiFleet Systems",
        message: (
            <>
                Grey InfoTech built a highly responsive and SEO-optimized logistics dashboard for us using Next.js.
                Their ability to handle both frontend complexity and backend integration was impressive. We now have a
                web app that performs great and represents our brand well.
            </>
        )
    }
];
